...
# One very important constant that isn't here, is the fire cooldown. We can shoot one bullet every 5 timesteps, which equates to 6 bullets fired per second.
