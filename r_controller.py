...
class RController(KesslerController):
    def __init__(self):
        ...
        rule11 = ctrl.Rule(bullet_time['S'] & theta_delta_fire['NL'], (ship_turn['NL'], ship_fire['N']))
        ...
        rule15 = ctrl.Rule(bullet_time['S'] & theta_delta_fire['PL'], (ship_turn['PL'], ship_fire['N']))
        ...
        # distance
        closest_asteroid_distance['S'] = fuzz.trimf(closest_asteroid_distance.universe,[0,50,150])
        ...
        # speed
        ship_speed['S'] = fuzz.trimf(ship_speed.universe,[0,0,40])
